...
<head>
    ...
    <title>Pelayanan Surat Keterangan Online Desa Cibongas</title>
    <!-- core CSS -->
...
<body id="home" class="homepage">
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms"><span>PELAYANAN</span> SURAT KETERANGAN <br> DESA CIBONGAS</h2>
                    ...
                    <div class="col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="300ms">
                        <div class="media service-box">
                            ...
                            <div class="media-body">
                                ...
                                <p>Permohonan di setujui oleh lurah, kemudian staf akan mencetak surat sesuai request surat yang diajukan, pemohon mengambil surat yang sudah dicetak dan bertandatangan di Kantor Desa Cibongas.</p>
                            </div>
                        </div>
                    </div>
                    <!--/.col-md-4-->
    ...
    <section id="contact">
        <div>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.844061834582!2d108.26920761425139!3d-7.699878194449467!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e65e8450e8a46cb%3A0x9ba72fb6c70d4305!2sKantor%20Desa%20Cibongas!5e0!3m2!1sid!2sid!4v1655765633348!5m2!1sid!2sid" width="100%" height="650px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>"  width="100%" height="650px" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0" alt="lokasi desa"></iframe>
        </div>
    </section>
    <!--/#bottom-->
    ...
    <footer id="footer">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    &copy; <?php echo date('Y');?> KANTOR DESA CIBONGAS KECAMATAN PANCATENGAH KABUPATEN TASIKMALAYA
                </div>
                <div class="col-sm-6">
